                        ...
                        @foreach ($products as $key => $product)
                            <tr id="product-row-{{ $product->id }}" class="{{ $product->is_active ? '' : 'table-secondary opacity-75' }}">
                                ...
                                <td>
                                    <div class="text-center">
                                        @if($product->item_code)
                                            <div class="barcode-img mb-1" style="display: inline-block;">
                                                {!! DNS1D::getBarcodeHTML($product->item_code, 'C128', 1.1, 22) !!}
                                            </div>
                                            <br>
                                            <small class="fw-bold text-dark">{{ $product->barcode_path ?: $product->item_code }}</small>
                                        @else
                                ...
                                <td class="text-center">
                                    ...
                                    <button type="button" class="btn btn-sm btn-info viewBreakdownBtn" 
                                        data-id="{{ $product->id }}" data-name="{{ $product->item_name }}">
                                        📍 Loc
                                    </button>
                        ...
                        <div class="col-md-4 mb-3 mb-md-0">
                            <div class="card h-100 border-0 shadow-sm rounded">
                                <div class="card-body p-3">
                                    ...
                                    <div class="text-center mb-3">
                                        <div id="view_barcode_container" class="p-2 bg-white border rounded d-inline-block">
                                            <!-- Barcode image will be injected here via JS -->
                                        </div>
