...
<body>
    ...
    <div class="invoice-container">
        ...
        <div class="company-info">
            <div class="company-name">Jannat ul Hayat </div>
            <div style="font-size: 12px;">OPP Kaka bakers, saddar, Hyderabad</div>
        ...
        <div class="row g-2 mb-2">
            ...
            <div class="col-4">
                <div class="info-box">
                    ...
                    @if($sale->walkin_name)
                        <div><span class="info-label">Name:</span> <strong>{{ $sale->walkin_name }}</strong></div>
                        <div class="text-muted" style="font-size: 10px;">(Walk-in)</div>
                    @else
                        ...
                        @endif
                        <div><span class="info-label">Name:</span> <strong>{{ $sale->customer_relation->customer_name ?? '—' }}</strong></div>
