            ...
            <form id="saleForm" autocomplete="off">
                ...
                <div class="d-flex gap-3 align-items-start border-bottom py-3">
                    ...
                    <div class="p-3 border rounded-3 minw-350">
                        ...
                        <div class="mb-2" id="customerSelectWrapper">
                        ...
                        <!-- WALK-IN NAME INPUT -->
                        <div class="mb-2 d-none" id="walkinNameWrapper">
                            <label class="form-label fw-bold mb-1">Walk-in Customer Name</label>
                            <input type="text" class="form-control" name="walkin_name" id="walkin_name" value="Walk-in" placeholder="Enter Name">
                        </div>
                    ...
                    <div class="flex-grow-1" style="min-width: 0;"> <!-- Fix flex overflow -->
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <div class="ms-auto me-3 d-flex align-items-center gap-2">
                                <i class="las la-barcode fs-4 text-primary"></i>
                                <input type="text" id="barcodeScanner" class="form-control form-control-sm border-primary" placeholder="Scan Barcode Here..." style="width: 220px; font-weight: bold;">
                            </div>
                            ...
                            <table class="table table-bordered sales-table mb-0">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 100px;">Bottle</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('change', 'input[name="partyType"]', function() {
                ...
                if (type === 'Walking Customer') {
                    $('#customerSelectWrapper').addClass('d-none');
                    $('#walkinNameWrapper').removeClass('d-none');
                    $('#customerInfoCard').addClass('d-none');
                } else {
                    $('#customerSelectWrapper').removeClass('d-none');
                    $('#walkinNameWrapper').addClass('d-none');
                }
            ...
            $('#btnPrint').on('click', function() {
                // If it's already posted, just open the invoice
                const bid = $('#booking_id').val();
                if (bid && $('#btnPosted').prop('disabled')) {
                    window.open('{{ url('sales') }}/' + bid + '/invoice', '_blank');
                } else {
                    // Trigger the Sale (Post) process which will open the invoice after posting
