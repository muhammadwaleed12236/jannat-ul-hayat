...
@section('content')
    ...
    @php
        // Dynamic Column Settings - can be moved to a global helper or config
        $showItemWarehouse = \App\Models\Setting::get('show_purchase_item_warehouse', true);
        $showItemLocation = \App\Models\Setting::get('show_purchase_item_location', true);
    @endphp
            ...
            <form id="purchaseForm" action="{{ route('store.Purchase') }}" method="POST" autocomplete="off">
                ...
                <div class="card shadow-sm mb-3">
                    <div class="card-body p-3">
                        <div class="row g-3">
                            <div class="col-md-2">
                                <label class="form-label fw-bold text-muted small">System No.</label>
                            ...
                            <div class="col-md-{{ $showItemWarehouse ? '3' : '1' }}">
                                ...
                                <textarea class="form-control" name="note" id="remarks" rows="1" placeholder="Notes..."></textarea>
                            </div>
                        </div>

                        <!-- VENDOR INFO CARD (Compact) -->
                        <div id="vendorInfoCard" class="mt-2 p-2 border rounded-2 bg-light d-none">
                            <div class="d-flex flex-wrap gap-4 align-items-center justify-content-between">
                                <div class="d-flex gap-2">
                                    <span class="fw-bold text-muted small">Mobile:</span>
                                    <span class="small" id="vi_mobile">—</span>
                                </div>
                                <div class="d-flex gap-2">
                                    <span class="fw-bold text-muted small">Address:</span>
                                    <span class="small" id="vi_address">—</span>
                                </div>
                                <div class="d-flex gap-2">
                                    <span class="fw-bold text-danger small">Prev. Bal:</span>
                                    <span class="small text-danger fw-bold" id="vi_prev_bal">0.00</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-bordered sales-table mb-0" id="purchaseTable">
                                <thead>
                                    <tr>
                                        ...
                                        @if($showItemWarehouse) <th class="col-wh" style="width: 120px;">WH</th> @endif
                                        @if($showItemLocation) <th class="col-loc" style="width: 100px;">Loc</th> @endif
                    ...
                    <div class="col-lg-5">
                        <div class="bg-white shadow-sm rounded-3 p-3 h-100 border">
                            ...
                            <div class="p-3 bg-light rounded-3 border">
                                <div class="summary-row row align-items-center">
                                ...
                                <div class="summary-row row align-items-center">
                                    ...
                                    <div class="col-5 text-end d-flex gap-1">
                                        <input type="number" class="form-control text-end form-control-sm"
                                            id="billDiscountPct" placeholder="%" style="width: 65px;" step="0.01">
                                        <input type="number" class="form-control text-end form-control-sm"
                                ...
                                <div class="summary-row row align-items-center">
                                    <div class="col-7 text-danger fw-medium">Prev. Bal</div>
                                    <div class="col-5 text-end text-danger fw-bold"><span id="tPrev">0.00</span></div>
                                </div>
                                <hr class="my-1 border-secondary opacity-25">
                                <div class="row py-1">
                                    <div class="col-6 fw-bold text-primary">Current Bill</div>
                                    <div class="col-6 text-end fw-bold text-primary"><span id="tPayable">0.00</span></div>
                                </div>
                                <div class="row py-1 bg-warning-subtle rounded-1">
                                    <div class="col-6 fw-bold text-dark">Total Payable</div>
                                    <div class="col-6 text-end fw-bold text-dark"><span id="tTotalPayable">0.00</span></div>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function addBlankRow() {
                ...
                let warehouseTd = showWarehouseCol ? `<td><select class="form-select form-select-sm" name="item_warehouse_id[]" style="font-size:0.75rem">${warehouseOptions}</select></td>` : '';
                let locationTd = showLocationCol ? `<td><input type="text" class="form-control form-control-sm" name="item_location[]" placeholder="Rack/Bin" style="font-size:0.75rem"></td>` : '';
