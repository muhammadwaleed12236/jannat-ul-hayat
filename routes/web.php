...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/get-products-by-subcategory/{subcategory_id}', [\App\Http\Controllers\ProductBottleMappingController::class, 'getProductsBySubcategory'])->name('fetch-products-by-subcategory');
    ...
    Route::get('/products/find-by-barcode', [ProductController::class, 'findByBarcode'])->name('products.find_by_barcode');
    ...
    Route::get('/sales/{id}/barcodes', [SaleController::class, 'saleBarcodes'])->middleware('permission:sales.view')->name('sales.barcodes');
    ...
    Route::get('/warehouse-stock/breakdown/{productId}', [WarehouseStockController::class, 'productBreakdown'])
        ->middleware('permission:warehouse.stock.view')
        ->name('warehouse_stock.product-breakdown');
